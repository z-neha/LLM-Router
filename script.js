...
function loginAs(username) {
  brandName.textContent = username;
  brandAvatar.textContent = username.charAt(0).toUpperCase();
  navActionsGuest.classList.add('hidden');
  navActionsUser.classList.remove('hidden');
}

document.querySelectorAll('[data-action="get-started"]').forEach((btn) =>
  btn.addEventListener('click', () => showScreen('screen-signup'))
);
...
document.querySelector('[data-action="sign-out"]').addEventListener('click', () => {
  ...
  brandAvatar.textContent = 'A';
  navActionsGuest.classList.remove('hidden');
  navActionsUser.classList.add('hidden');
  showScreen('screen-landing');
});

document.querySelector('[data-action="how-it-works"]').addEventListener('click', (e) => {
  e.preventDefault();
  showScreen('screen-how-it-works');
});

document.querySelector('[data-action="about"]').addEventListener('click', (e) => {
  e.preventDefault();
  showScreen('screen-about');
});

document.querySelector('[data-action="go-signup"]').addEventListener('click', () => showScreen('screen-signup'));
document.querySelector('[data-action="go-signin"]').addEventListener('click', () => showScreen('screen-signin'));
